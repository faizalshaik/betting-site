	...
	<body>
		...
		<div class="wrapper-page">
			...
			<div class="panel-heading"> 
				<h3 class="text-center"> Sign In to <strong class="text-custom">Bet2Star</strong> </h3>
			</div> 
			...
			<form class="form-horizontal m-t-20" action="<?php echo base_url().'Cms/auth_user'?>" data-parsley-validate novalidate method="post">
				<div class="form-group ">
					<div class="col-xs-12">
						<input class="form-control" parsley-trigger="change"  type="text" required placeholder="Email" 
