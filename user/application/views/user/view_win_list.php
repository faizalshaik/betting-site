...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="page-title">Win List</h4>
...
<script type="text/javascript">
    ...
    tbl2 = initTable("#table2",
        ...
        ], "<?php echo site_url('Cms_api/get_win_lists/'.$curWeekNo.'/0/0') ?>");

        function onSearch()
        {
            var week = document.getElementById('week').value;
            var terminalId = document.getElementById('terminal').value;
            tbl2.ajax.url("<?php echo site_url('Cms_api/get_win_lists')?>" + "/" + week + "/0/" + terminalId);
            tbl2.ajax.reload();
        }
